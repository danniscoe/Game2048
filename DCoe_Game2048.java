//I made it to level 15.  I will keep working on the code. =)
...
public class Game2048 extends Game {
    ...
    private void gameOver() {
        showMessageDialog(Color.NONE, "OOPS! TRY AGAIN!", Color.WHITE, 50);
        isGameStopped = true;
    }

    private void win() {
        showMessageDialog(Color.NONE, "YOU'RE A WINNER!", Color.WHITE, 50);
        isGameStopped = true;
    }
